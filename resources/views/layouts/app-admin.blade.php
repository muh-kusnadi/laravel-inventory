          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="{{route('admin.edit', Auth::user()->id)}}" class="btn btn-default btn-flat">Profile</a>
                </div>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
            <a href="{{route('user.iventory.index')}}">
                <i class="fa fa-bank"></i> <span>Users Inventory</span>
            </a>
        </li>
        <li>
...
<script src="{{URL::asset('datatable/js/dataTables.bootstrap.min.js')}}"></script>
<script>
